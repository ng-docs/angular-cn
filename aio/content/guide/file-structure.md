...
| :--------------------------------------- | :------ |
| Application-specific configuration files | 用途 |
...
| `.browserslistrc` | 配置各种前端工具之间共享的目标浏览器和 Node.js 版本。欲知详情，请参阅 [GitHub 上的浏览器列表](https://github.com/browserslist/browserslist)。 |
