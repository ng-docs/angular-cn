...
To ensure listeners are shut down when AngularJS isn't being displayed, configure an `otherwise` option with the [&dollar;routeProvider][AngularjsDocsApiNgrouteProviderRouteprovider] that renders an empty template.
