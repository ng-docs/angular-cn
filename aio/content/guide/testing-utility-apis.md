...
| `whenStable`        | 返回一个 Promise，在 fixture 稳定时解析。<br />要想在完成了异步活动或异步变更检测之后再继续测试，可以对那个 Promise 对象进行挂钩。参阅 [whenStable](guide/testing-components-scenarios#when-stable)。|
