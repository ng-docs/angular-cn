...
npm package manager <a id="npm"></a>
...
Angular 需要 Node.js 的[活跃 LTS 版或维护期 LTS 版](https://nodejs.org/about/releases)。<div class="alert is-helpful"> 欲知详情，请参阅[版本兼容指南](guide/versions)。</div> 要了解如何安装 Node.js，参阅 [nodejs.org](http://nodejs.org "Nodejs.org")。如果你不确定系统中正在运行的 Node.js 版本是什么，请在终端窗口中运行 `node -v`。
