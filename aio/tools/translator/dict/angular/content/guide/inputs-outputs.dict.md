...
Use [property binding](guide/property-binding) to bind the `item` property in the child to the `currentItem` property of the parent.
...
Tells Angular to create a new event emitter and that the data it emits is of type string.
