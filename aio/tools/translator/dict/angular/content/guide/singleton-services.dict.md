...
要想深入了解关于服务的信息，参阅[《英雄之旅》教程](tutorial/tour-of-heroes)中的[服务](tutorial/tour-of-heroes/toh-pt4)一章。
...
In this example, the `GreetingModule` class

在这个例子中，就是 `GreetingModule` 类。
